...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    //底部导航栏的总布局
    private LinearLayout llayout_home, llayout_message, llayout_person;
    //底部导航栏的图标
    private ImageView iv_home, iv_message, iv_person, iv_current;
    //底部导航栏的文字
    private TextView tv_home, tv_message, tv_person, tv_current;
    //记录当前点击返回键的时间
